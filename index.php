...
<body class="container-fluid">
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary"> 
	  <div class="col-sm-2"><h5 class="usuario">Profesionales en Recuperacion</h5></div>
    	...
    	<div class="logg" >
					<h5 class="usuario"><i class="bi-person-fill" type="button" ></i></a><a type="button"  href="model/cerrar.php" role="button"> <i class="bi-toggle-on" style="font-size: 1.5rem; color: LawnGreen;"></i> </a></h5>
			</div>  
  </nav>
  		<br/>
  		<br/>
